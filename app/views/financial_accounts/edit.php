...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= BASE_URL ?>/financial-accounts"
        class="bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2.5 rounded-lg text-sm font-medium transition">
        ← Back to Accounts
    </a>
</div>
...
<div class="bg-white rounded-xl shadow-sm border max-w-lg">
